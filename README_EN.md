...
The source code is licensed under [GNU AGPL v3.0 or later](./LICENSE). Contact the maintainer for closed-source commercial licensing. Promotional assets, screenshots, the EasyPPT name, and brand marks are excluded from the AGPL license; see [LICENSING.md](./LICENSING.md) for details.
